...
@RunWith(Suite.class)
@SuiteClasses({ HTMLParseTest.class, ArticleImageTest.class, ArticleTitleTest.class, HTMLParseTest.class, PaginationTest.class, URLErrorTest.class, URLTest.class })
