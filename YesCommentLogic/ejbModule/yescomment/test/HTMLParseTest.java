...
public class HTMLParseTest {
	...
	public void testHTMLKeywords() throws MalformedURLException, IOException {
		...
		assertNull(HTMLParser.getMetaValue("http://plastik.hu/2013/10/10/gaget-soon/","keywords"));
		assertEquals("városliget, pecsa, zugló, bolhapiac, Belföld",HTMLParser.getMetaValue("http://www.index.hu/belfold/2013/10/03/utott_a_varosligeti_bolhapiac_utolso_oraja","keywords"));
		assertEquals("pc piac idc gartner hp lenovo acer asus dell",HTMLParser.getMetaValue("http://www.hwsw.hu/hirek/51099/pc-piac-idc-gartner-hp-lenovo-acer-asus-dell.html","keywords"));
		assertEquals("CNN,CNN Video,CNN news,CNN.com,CNN TV,news,news online,breaking news,U.S. news,world news,weather,business,CNN Money,sports,politics,law,technology,entertainment,education,travel,health,special reports,autos,developing story,news video,CNN Intl",HTMLParser.getMetaValue("http://edition.cnn.com/video/?/video/bestoftv/2013/10/10/pkg-foster-alzheimers-family.cnn","keywords"));
		assertEquals("nfü, számít a szava, uniós források, Gazdaság",HTMLParser.getMetaValue("http://index.hu/gazdasag/2013/10/28/ennek_az_egyeztetesnek_meg_mi_ertelme/","keywords"));
